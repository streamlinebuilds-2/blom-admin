-- ========================================
-- BLOM COSMETICS - DATABASE CLEANUP & PRODUCT IMPORT
-- ========================================
-- This script archives existing products and imports clean data from staticProducts
...
-- ========================================
-- Archive all existing products (keep for order history)
UPDATE products
